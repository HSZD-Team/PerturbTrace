...
- input_table: `BDAbench/data_sources/raw_external/S25_shifrut_primary_tcell_crispr/shifrut_fitdb_nonproliferating_vs_highproliferating_advantageous.csv`
- normalized_oracle_table: `BDAbench/tasks/c3_primary_tcell_function_screen_v0/hidden/oracle_scores.csv`
- normalized_hit_set: `BDAbench/tasks/c3_primary_tcell_function_screen_v0/hidden/hit_set.npy`
- public_candidate_actions: `BDAbench/tasks/c3_primary_tcell_function_screen_v0/public/candidate_actions.csv`
- matrix_mode: `long`
...
license_or_terms: FITdb public web API; retain API path and exact comparison in judge-only
  provenance
raw_files:
- path: BDAbench/data_sources/raw_external/S25_shifrut_primary_tcell_crispr/fitdb_cell_vs_cell_4_advantageous.json
  ...
  size_bytes: 1800555
- path: BDAbench/data_sources/raw_external/S25_shifrut_primary_tcell_crispr/fitdb_cell_vs_cell_4_disadvantageous.json
  ...
  size_bytes: 1663391
- path: BDAbench/data_sources/raw_external/S25_shifrut_primary_tcell_crispr/shifrut_fitdb_nonproliferating_vs_highproliferating_advantageous.csv
...
normalization_plan:
  ...
  command: .\BioDiscoveryAgent_repo\.venv\Scripts\python.exe .\BDAbench\data_sources\normalize_action_score_table.py
    --source-id S25_shifrut_primary_tcell_crispr --input-table .\BDAbench\data_sources\raw_external\S25_shifrut_primary_tcell_crispr\shifrut_fitdb_nonproliferating_vs_highproliferating_advantageous.csv
