...
- source_id: `S14_gdsc`
- input_table: `PerturbTrace/data_sources/raw_external/S14_gdsc/gdsc2_sidm00136_drug_auc.csv`
- normalized_oracle_table: `PerturbTrace/tasks/c3_gdsc_drug_response_v0/hidden/oracle_scores.csv`
- normalized_hit_set: `PerturbTrace/tasks/c3_gdsc_drug_response_v0/hidden/hit_set.npy`
- public_candidate_actions: `PerturbTrace/tasks/c3_gdsc_drug_response_v0/public/candidate_actions.csv`
- matrix_mode: `long`
...
raw_files:
- path: PerturbTrace/data_sources/raw_external/S14_gdsc/gdsc2_sidm00136_drug_auc.csv
  ...
  size_bytes: 5763
- path: PerturbTrace/data_sources/raw_external/S14_gdsc/GDSC2_fitted_dose_response_27Oct23.xlsx
...
normalization_plan:
  ...
  command: .\BioDiscoveryAgent_repo\.venv\Scripts\python.exe .\PerturbTrace\data_sources\normalize_action_score_table.py
    --source-id S14_gdsc --input-table .\PerturbTrace\data_sources\raw_external\S14_gdsc\gdsc2_sidm00136_drug_auc.csv
...
- Derived input table: `PerturbTrace/data_sources/raw_external/S14_gdsc/gdsc2_sidm00136_drug_sensitivity_zscore.csv`.
