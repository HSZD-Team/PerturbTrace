...
- input_table: `PerturbTrace/data_sources/raw_external/S27_haney_phagocytosis_crispr/haney_orcs_screen1140_phagocytosis_castle.csv`
- normalized_oracle_table: `PerturbTrace/tasks/c3_phagocytosis_crispr_screen_v0/hidden/oracle_scores.csv`
- normalized_hit_set: `PerturbTrace/tasks/c3_phagocytosis_crispr_screen_v0/hidden/hit_set.npy`
- public_candidate_actions: `PerturbTrace/tasks/c3_phagocytosis_crispr_screen_v0/public/candidate_actions.csv`
- matrix_mode: `long`
...
raw_files:
- path: PerturbTrace/data_sources/raw_external/S27_haney_phagocytosis_crispr/BIOGRID-ORCS-SCREEN_1140-2.0.18.screen.tab.txt
  ...
  size_bytes: 2124431
- path: PerturbTrace/data_sources/raw_external/S27_haney_phagocytosis_crispr/BIOGRID-ORCS-SCREEN_INDEX-2.0.18.index.tab.txt
  ...
  size_bytes: 1328911
- path: PerturbTrace/data_sources/raw_external/S27_haney_phagocytosis_crispr/haney_orcs_screen1140_phagocytosis_castle.csv
  ...
  size_bytes: 496696
- path: PerturbTrace/data_sources/raw_external/S27_haney_phagocytosis_crispr/haney_orcs_screen1140_metadata.json
...
normalization_plan:
  ...
  command: python .\PerturbTrace\data_sources\prepare_orcs_static_screen_task_table.py
    --source-id S27_haney_phagocytosis_crispr --screen-file .\PerturbTrace\data_sources\raw_external\S27_haney_phagocytosis_crispr\BIOGRID-ORCS-SCREEN_1140-2.0.18.screen.tab.txt
    --output-csv .\PerturbTrace\data_sources\raw_external\S27_haney_phagocytosis_crispr\haney_orcs_screen1140_phagocytosis_castle.csv
    --metadata-json .\PerturbTrace\data_sources\raw_external\S27_haney_phagocytosis_crispr\haney_orcs_screen1140_metadata.json
    --score-column SCORE.1 --hit-column SCORE.1 --score-aggregation max --hit-aggregation
    max; python .\PerturbTrace\data_sources\normalize_action_score_table.py --source-id
    S27_haney_phagocytosis_crispr --input-table .\PerturbTrace\data_sources\raw_external\S27_haney_phagocytosis_crispr\haney_orcs_screen1140_phagocytosis_castle.csv
