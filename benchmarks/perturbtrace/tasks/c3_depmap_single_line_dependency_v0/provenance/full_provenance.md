...
- input_table: `PerturbTrace/data_sources/raw_external/S09_depmap_achilles/depmap_26q1_frozen_context_gene_effect.csv`
- normalized_oracle_table: `PerturbTrace/tasks/c3_depmap_single_line_dependency_v0/hidden/oracle_scores.csv`
- normalized_hit_set: `PerturbTrace/tasks/c3_depmap_single_line_dependency_v0/hidden/hit_set.npy`
- public_candidate_actions: `PerturbTrace/tasks/c3_depmap_single_line_dependency_v0/public/candidate_actions.csv`
- matrix_mode: `long`
...
raw_files:
- path: PerturbTrace/data_sources/raw_external/S09_depmap_achilles/CRISPRGeneEffect_26Q1.csv
...
- path: PerturbTrace/data_sources/raw_external/S09_depmap_achilles/depmap_26q1_frozen_context_gene_effect.csv
...
normalization_plan:
  ...
  command: .\BioDiscoveryAgent_repo\.venv\Scripts\python.exe .\PerturbTrace\data_sources\normalize_action_score_table.py
    --source-id S09_depmap_achilles --input-table .\PerturbTrace\data_sources\raw_external\S09_depmap_achilles\depmap_26q1_frozen_context_gene_effect.csv
